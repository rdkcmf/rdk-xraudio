...
typedef enum {
   ...
   XRAUDIO_INPUT_STATE_PENDING   = 2,
   XRAUDIO_INPUT_STATE_RECORDING = 3,
   XRAUDIO_INPUT_STATE_STREAMING = 4,
   XRAUDIO_INPUT_STATE_DETECTING = 5,
   XRAUDIO_INPUT_STATE_INVALID   = 6,
